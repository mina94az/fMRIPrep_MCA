...
for ((rep=1; rep<=$REPEATS; rep++)); do
    ...
    for ((subj=1; subj<=$SUBJECTS_PER_REPEAT; subj++)); do
        if [[ $subj -le 9 ]]; then
            ...
            INPUT_FILE="$BASE_DIR/fmriprep_mca-output/iter_${rep}/sub-126BPCP02100${subj}/ses-1/func/sub-126BPCP02100${subj}_ses-1_task-rest_desc-coreg_boldref.nii.gz"
            OUTPUT_FILE="$BASE_DIR/fmriprep_mca-output/iter_${rep}/sub-126BPCP02100${subj}/ses-1/func/sub-126BPCP02100${subj}_ses-1_task-rest_coreg-bold_flirt.nii.gz"
            ...
            # Define input and output file paths
            INPUT_FILE="$BASE_DIR/fmriprep_mca-output/iter_${rep}/sub-126BPCP0210${subj}/ses-1/func/sub-126BPCP0210${subj}_ses-1_task-rest_desc-coreg_boldref.nii.gz"
            OUTPUT_FILE="$BASE_DIR/fmriprep_mca-output/iter_${rep}/sub-126BPCP0210${subj}/ses-1/func/sub-126BPCP0210${subj}_ses-1_task-rest_coreg_bold_flirt.nii.gz"
